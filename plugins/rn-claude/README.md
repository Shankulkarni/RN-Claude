...
|---|---|
| `/rn-claude:setup` | Verify project environment is correctly configured |
| `/rn-claude:scaffold` | Scaffold a new Expo app with full stack |
...
| `/rn-claude:update` | Pull latest plugin version |
| `/rn-claude:uninstall` | Remove plugin from project |
